package no.novari.drosjeloyve.repository;
...
public interface AltinnApplicationRepository extends MongoRepository<AltinnApplication, String> {
    ...
    @Query(value = "{}", fields = "{archiveReference: 1, appId: 1,  caseId: 1, requestor: 1, requestorName: 1, subject: 1, subjectName: 1, status: 1, archivedDate: 1, updatedDate: 1}")
    List<AltinnApplication> findAllMinified();

    @Query(value = "{'requestor': ?0}", fields = "{archiveReference: 1, appId: 1, caseId: 1, requestor: 1, requestorName: 1, subject: 1, subjectName: 1, status: 1, archivedDate: 1, updatedDate: 1}")
